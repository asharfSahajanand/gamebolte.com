...
const GA_MEASUREMENT_ID = "G-CCNGEXHV4X";
...
function gtag_report_conversion(url) {
  ...
  gtag("event", "conversion", {
    send_to: "AW-17974522235/JQm3CJqv0v4bEPvi9fpC",
    value: 0.1,
    currency: "AED",
...
(async function initDisplayAds() {
  ...
  const adSlots = [
    { adUnit: "/23330730517/gamebolte.com_d1", divId: "myw_top_1" },
    { adUnit: "/23330730517/gamebolte.com_d2", divId: "myw_top_2" },
    { adUnit: "/23330730517/gamebolte.com_d3", divId: "myw_top_3" },
  ];
    ...
    googletag.cmd.push(function () {
      try {
        ...
        currentSlot = googletag
          .defineOutOfPageSlot(
            "/23330730517/gamebolte.com_reward",
...
console.log("🚀 Ad Floor System Initialized");